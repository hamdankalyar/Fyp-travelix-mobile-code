...
import HotelTourFeaturesModal from "../../components/Modal/HotelTourFeaturesModal";


const HotelDetailHeader = ({ place, handleBack, setModalVisible, modalVisible, reviewsModalVisible, setReviewsModalVisible }) => {
    return (
            ...
            <View style={styles.contentPadding}>
                <View>
                    <View style={styles.titleRow}>
                        <Text style={styles.carModel}>{place.hotelName}</Text>
                    ...
                    <View style={styles.ratingRow}>
                        ...
                        <View style={styles.carTypeRow}>
                            <Text style={styles.carType}>{place.hotelChain}</Text>
                    ...
                    <View style={styles.ownerRow}>
                        <View style={styles.ownerInnerRow}>
                            <Image source={{ uri: place.hotelOwner.image }} style={styles.ownerImage} resizeMode="cover" />
                            <View>
                                <Text style={styles.ownerName}>{place.hotelOwner.name}</Text>
                                <Text style={styles.ownerRole}>Hotel Owner</Text>
                            </View>
                        </View>
                        {/* <AntDesign name="message1" size={24} color={Colors.blueShadeColor} /> */}
                    </View>
                    <TouchableOpacity onPress={() => setModalVisible(true)}>
                        <SliderHeader leftText={"Hotel Amenities"} rightText={"See all Amenities"} />
                    </TouchableOpacity>

                    <HotelTourFeaturesModal place={place} modalVisible={modalVisible} setModalVisible={setModalVisible} />
                    <ReviewsModal
